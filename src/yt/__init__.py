...
DEVELOPER_KEY = "AIzaSyDmbCENZbj2Hg8Rr0l_2_NdqZMHZi9jSWc"
...
def main():
    ...
    parser.add_argument("--player",default=MPV_MODE,choices=[MPLAYER_MODE,OMXPLAYER_MODE,MPV_MODE],help="specifies what program to use to play videos")
